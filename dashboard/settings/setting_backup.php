...
<div class="panel panel-primary">
  ...
  <button type="submit" name="backup" class="btn btn-default btn-xs"><i class="fa fa-database fa-fw"></i> <?php echo @LA_LB_BACKUP_NOW;?></button><?php //echo dirname(__FILE__);?></form></span>
                        </div>
  ...
  <tr class="table_header">
    ...
    <td width="27%" align="center" ><?php echo @LA_LB_FILE_NAME;?></td>
    <td width="18%" align="center" ><?php echo @LA_LB_DATE;?></td>
    <td width="19%" align="center" ><?php echo @LA_LB_USER;?></td>
    <td width="29%" align="center" ><?php echo @LA_LB_MANAGE;?></td>
  </tr>
  </thead>
  <tbody>
  <?php
