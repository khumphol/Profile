...
<div class="modal fade" id="edit_user_x" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
  ...
  <tr id="<?php echo @$showalluser->user_key;?>">
    ...
    <td align="center"> <?php
	  ...
	  ?><a data-toggle="modal" data-target="#edit_user_x" data-whatever="<?php echo @$showalluser->user_key;?>" class="btn btn-info btn-xs " style="color:#FFF;"><i class="fa fa-edit fa-fw"></i> <?php echo @LA_BTN_EDIT;?></a><a href="?p=setting_user_access&key=<?php echo @$showalluser->user_key;?>" class="btn btn-default btn-xs " ><i class="fa fa-gear fa-fw"></i><?php echo @LA_BTN_ACCESS;?></a><button type="button" class="btn btn-danger btn-xs " onClick="javascript:deleteUser('<?php echo @$showalluser->user_key;?>');"><i class="fa fa-times fa-fw"></i><?php echo @LA_BTN_DELETE;?></button></td>
  </tr>
   <?php
	   }
   ?>
