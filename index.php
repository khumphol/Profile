...
<head>
    ...
    <meta name="author" content="Khumphol  Tearmpin">
...
<style>
   html {
	...
	body{
		font-size:16px;
         background: url('media/bg/bg.png')  center center fixed no-repeat ;
         webkit-background-size: cover;
        moz-background-size: cover;
        o-background-size: cover;
        background-size: cover ;

    filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='media/bg/bg.png',     sizingMethod='scale');
    -ms-filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='media/bg/bg.png', sizingMethod='scale');
	}
	</style>
</head>
<?php
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    ?>
                        ...
                        <div style="color:#CCC; text-align:center; padding-top:10px;">&copy;&nbsp;<?php echo date("Y");?>&nbsp;Profile By Nattarin</div>
                    </div>
